> **xPNTsFactoryActions**(`address`): (`client`) => [`XPNTsFactoryActions`](../../core/type-aliases/XPNTsFactoryActions.md)

Defined in: [packages/core/src/actions/factory.ts:121](https://github.com/AAStarCommunity/aastar-sdk/blob/6b49b22ad2e2ee38472f13bd530a515b9eb58add/packages/core/src/actions/factory.ts#L121)
...
> (`client`): [`XPNTsFactoryActions`](../../core/type-aliases/XPNTsFactoryActions.md)
...
[`XPNTsFactoryActions`](../../core/type-aliases/XPNTsFactoryActions.md)
