...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"api/@aastar/core/variables/CONTRACT_SRC_HASH.md","filePath":"api/@aastar/core/variables/CONTRACT_SRC_HASH.md","lastUpdated":1768812366000}');
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    ...
    createBaseVNode("p", null, [
      ...
      createBaseVNode("a", {
        href: "https://github.com/AAStarCommunity/aastar-sdk/blob/aa02be8b7cbec344159ad823f08cb0202e9ec8b8/packages/core/src/constants.ts#L16",
        target: "_blank",
        rel: "noreferrer"
