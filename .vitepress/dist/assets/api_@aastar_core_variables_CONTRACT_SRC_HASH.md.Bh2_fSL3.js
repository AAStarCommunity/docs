...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [..._cache[0] || (_cache[0] = [
    ...
    createBaseVNode("p", null, [
      ...
      createBaseVNode("a", {
        href: "https://github.com/AAStarCommunity/aastar-sdk/blob/89f481b5e82d27cdc5d83f918ddad6748e0e7c3e/packages/core/src/constants.ts#L47",
        target: "_blank",
        rel: "noreferrer"
      }, "packages/core/src/constants.ts:47")
    ], -1),
