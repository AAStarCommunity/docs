...
const __pageData = JSON.parse('{"title":"Admin API Reference","description":"","frontmatter":{},"headers":[],"relativePath":"api/roles/admin.md","filePath":"api/roles/admin.md"}');
const _sfc_main = { name: "api/roles/admin.md" };
